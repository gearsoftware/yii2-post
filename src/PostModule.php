...
class PostModule extends \yii\base\Module
{
    ...
    public $controllerNamespace = 'gearsoftware\post\controllers';
    public $viewList;
    public $layoutList;
     ...
     * @var string
     */
    public $postModelClass = 'gearsoftware\post\models\Post';
     ...
     * @var string
     */
    public $postModelSearchClass = 'gearsoftware\post\models\search\PostSearch';
     ...
     * @var string
     */
    public $tagModelClass = 'gearsoftware\post\models\Tag';
     ...
     * @var string
     */
    public $tagModelSearchClass = 'gearsoftware\post\models\search\TagSearch';
     ...
     * @var string
     */
    public $categoryModelClass = 'gearsoftware\post\models\Category';
     ...
     * @var string
     */
    public $categoryModelSearchClass = 'gearsoftware\post\models\search\CategorySearch';
     ...
     *
     * Expected values: 'original' or sizes from gearsoftware\media\MediaModule::$thumbs,
     ...
     *
     *   'post' => [
     *       'class' => 'gearsoftware\post\PostModule',
     *       'viewList' => [
     *           'post' => 'View Label 1',
